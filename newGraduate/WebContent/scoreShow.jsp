	...
	<center>
		...
		<form action="#.jsp" method="post" onsubmit="return validate()">
			<table border="1" bordercolor="#A0A0A0">
				...
				%>
				<tr>
					<td><input type="text" value="<%=tl.getUsual_grade()%>"
						  readonly="readonly"></td>
					<td><input type="text" value="<%=tl.getReply_grade()%>"
						  readonly="readonly"></td>
					<td><input type="text" value="<%=tl.getTotal_grade()%>"
					  readonly="readonly"></td>
					<td><input type="text" value="<%=tl.getTech_id()%> "
						  readonly="readonly"></td>
					<td><input type="text" value="<%=tl.getStu_id()%> "
						  readonly="readonly"></td>
				</tr>
				<%
					}
