...
<center>
	...
	<form action = "addtechnews.jsp" method = "post" onsubmit = "return validate()">
  	<table width="300" height = "180" border="5" bordercolor="#A0A0A0">
  	  <tr>
		<th>用户编号：</th>
		<td><input type="text" name="userid" value="<%=tech_id %>" readonly="readonly" ></td>
 	  </tr>
  	  <tr>
		<th>用户名：</th>
 	  ...
 	  <tr>
        ...
        <input  type="radio" checked="checked" name="type" value="tech" readonly="readonly"/>教师</td>
 	  </tr>
	  <tr>
