	...
	//JDBC 驱动名及数据库 URL
		...
		try {
			...
			if (!repassword.equals(password)) {
				...
				response.setHeader("refresh", "0;url=stunews.jsp");
			}
			String sql;
			Boolean pwd;
			sql = "UPDATE student SET stu_name='" + name + "',stu_pwd='" + password + "',stu_tel='" + tel
					+ "'  WHERE stu_id='" + stu_id + "'";
			stmt.executeUpdate(sql);
			out.print("<script type='text/javascript' language='javaScript'> alert('修改学生信息成功');</script>");
		} finally {
			// 完成后关闭
