...
<body>
<center>
<font face="楷体"   size="6" color="#000">上传论文批改界面</font>
 
   <form name="formName" action = "tech_file.jsp" method = "post" onsubmit = "return validate()">
  ...
  <input type="radio" name="no"   title="选择/不选择" value="<%=tl.getTitle_id() %>"></td>  
   ...
   <td > 
     ...
     <%}  }
        ...
        上传的文件名： <input type="text" name="tech_fil"  value="${techfile}"   readonly="readonly"/> </td>    
          </tr>  	    
	   <tr       height="30">
 		<td colspan = "9" align = "center">
